<template>
   ...
   <div id="videos">
    ...
    <footer>
        <div id="sharing-div">
            <div id="room-link">Waiting for someone to join this call: <a id="room-link-href" href="" target="_blank"></a></div>
        </div>
        <div id="info-div"></div>
    ...
    methods: {
        ...
        // request.headers['Authorization'] = 'Bearer ' + store.state.context.jwtToken
            var loadingParams = {
                ...
                iceServerRequestUrl: 'http://localhost:5100/api/nts/iceservers',
                iceServerTransports: '',
                wssUrl: 'ws://localhost:5100/ws',
                wssPostUrl: 'ws://localhost:5100/ws',
                roomServer: 'http://localhost:5100/api/room',
