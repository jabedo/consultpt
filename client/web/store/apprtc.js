   ...
   /*    this.newRoomButton_ = $(UI_CONSTANTS.newRoomButton);
    ...
    AppController.prototype.loadUrlParams_ = function() {
      ...
      this.loadingParams_.videoRecvCodec =
        urlParams["vrc"] || DEFAULT_VIDEO_CODEC;
...
/*       this.signalrSignaller = signalrSignaller, */
        ...
        if (localAddr && remoteAddr) {
          ...
          contents += this.buildLine_(
            ...
            localAddr +
              " (" +
              localAddrType +
              (typeof relayProtocol !== undefined
    ...
    InfoBox.prototype.buildStatsSection_ = function() {
      ...
      if (statReport.connection.remoteIp !== "") {
        ...
        contents += this.buildLine_(
          "CurrentRtt",
          InfoBox.formatMsec_(currentRtt)
        );
      }
    ...
    var PeerConnectionClient = function(params, startTime) {
      ...
      this.pc_.onsignalingstatechange = this.onSignalingStateChanged_.bind(
        this
      );
    ...
    PeerConnectionClient.prototype.processSignalingMessage_ = function(
      message
    ) {
    ...
    PeerConnectionClient.prototype.filterIceCandidate_ = function(
      candidateObj
    ) {
