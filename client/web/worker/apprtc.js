export default {
    ...
    Promise.resolve(paramsPromise)
      ...
      AppController.prototype.setupUi_ = function() {
        ...
        $(UI_CONSTANTS.fullscreenSvg).onclick = this.toggleFullScreen_.bind(
          this
        );
      ...
      AppController.prototype.waitForRemoteVideo_ = function() {
        if (this.remoteVideo_.readyState >= 2) {
          trace(
            "Remote video started; currentTime: " +
        ...
        if (!this.remoteVideoResetTimer_) {
          this.remoteVideoResetTimer_ = setTimeout(
            function() {
              this.remoteVideoResetTimer_ = null;
              trace(
                "Resetting remoteVideo src after transitioning to waiting."
              );
