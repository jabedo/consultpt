  ...
  this.roomJoinButton_.removeEventListener("click", this.roomJoinButtonListener_);
    ...
    RoomSelection.prototype.buildRecentRoomList_ = function(recentRooms) {
      ...
      for (var i = 0; i < recentRooms.length; ++i) {
        ...
        href.href =
          location.origin + "/r/" + encodeURIComponent(recentRooms[i]);
        li.appendChild(href);
    ...
    function findFmtpLine(sdpLines, codec) {
      ...
      return payload
        ? findLine(sdpLines, "a=fmtp:" + payload.toString())
        : null;
    }
    ...
    SignalingChannel.prototype.open = function() {
      ...
      return new Promise(
        function(resolve, reject) {
          if (isChromeApp()) {
            this.websocket_ = new RemoteWebSocket(
              this.wssUrl_,
              this.wssPostUrl_
            );
          } else {
            ...
            switch (report.type) {
              ...
              case "inbound-rtp":
                if (report.hasOwnProperty("trackId")) {
                  if (report.trackId.indexOf(remoteTrackIds.audio) !== -1) {
                    statsObject.audio.remote.bytesReceived =
                  ...
                  if (report.trackId.indexOf(remoteTrackIds.video) !== -1) {
                    statsObject.video.remote.bytesReceived =
                      report.bytesReceived;
              ...
              case "candidate-pair":
                if (report.hasOwnProperty("availableOutgoingBitrate")) {
                  ...
                  statsObject.connection.localCandidateId =
                    report.localCandidateId;
                  statsObject.connection.remoteCandidateId =
                    report.remoteCandidateId;
                  statsObject.connection.requestsReceived =
                    report.requestsReceived;
              ...
              case "track":
                if (report.hasOwnProperty("trackIdentifier")) {
                  ...
                  if (
                    ...
                    statsObject.video.remote.framesDecoded =
                      report.framesDecoded;
                    statsObject.video.remote.framesDropped =
                      report.framesDropped;
                    statsObject.video.remote.framesReceived =
              ...
              case "local-candidate":
                if (report.hasOwnProperty("id")) {
                  if (
                    ...
                    statsObject.connection.localRelayProtocol =
                      report.relayProtocol;
                  }
                }
                break;
